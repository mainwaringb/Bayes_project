...
hist(preSurvey$Fav_AfD, main = '', xlab = "AfD favourability (pre-election)", ylim = c(0,1000), las = 1)
#axis(side = 2, at = c(0, 200, 400, 600, 800, 1000), labels = c(0, 200, 400, 600, 800, 1000), las = 1)
hist(postSurvey$Fav_AfD, main = '', xlab = "AfD favourability (post-election)", ylim = c(0,1000), las = 1)
...
The effects of individual-level variables were more stable. The estimated effect of household unemployment was notably smaller in the post-election survey, and the curve relating age to AfD favourability was somewhat different. However, posterior means were otherwise very similar. Standard deviations in the post-election shrunk by a relatively consistent factor, on average round(mean((beta.compare[,4] - beta.compare[,2]) / beta.compare[,4]), 2)`.
